...
<head>
	...
	<div class="col-md-4"> <span class="pull-right">&nbsp&nbsp Cart</span></div>
               <div class="col-md-4"><span class="pull-right"><a href="Login">&nbsp&nbsp Login</a></span></div>
              <!--  <div class="col-md-4"><span class="pull-right">Create an Account</span></div>
				 -->	</div>
					</div>
...
<ul class="nav navbar-nav" id="header">
                     ...
                     <li>
                          <a href="#">&nbsp&nbsp&nbsp&nbspFeedback</a>	 
                          </li>
</ul>  
	<br>	             	              
...
<div class="container" id="form">
    ...
    <label for="login">TakeBook Login
    </label>
