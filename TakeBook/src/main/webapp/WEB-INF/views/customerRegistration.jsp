...
<div class="container" id="customerregistration">
    <form style="border: solid 2px" position:"center">
    <div class="form-group text-info" id="label">
    <label for="heading">Welcome to Takebook</label>
    </div>
     <div class="form-group" id="field">
            <label for="Name" > Name</label>
            <input type="text" class="form-control input-large" id="input-large" placeholder="Name">
        </div>
        <div class="form-group" id="field">
        ...
        <div class="form-group" id="field">
            ...
            <input type="password" class="form-control input-large" id="input-large" placeholder="Password">
       </div>
           <div class="form-group" id="field">
